...
def main():
    ...
    if config["FLASK_ENV"] == "development":
        config["DATABASE_URL"] = "sqlite:///db/local.db"
    else:
    ...
    if prompt_user("Do you want to configure email settings? (y/n)", default="n", required=False) == "y":
        ...
        config["MAIL_USE_TLS"] = prompt_user("Use TLS? (true/false)", default="true", required=True)
