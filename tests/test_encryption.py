...
class TestIntegrationScenarios:
    ...
    def test_full_user_encryption_workflow(self):
        ...
        decrypted_master_key = decrypt_master_key(
            encrypted_master_key, user_password, user_salt
        )
    ...
    def test_key_rotation_scenario(self):
        ...
        decrypted_master_key = decrypt_master_key(
            old_encrypted_master_key, old_password, salt
        )
        new_encrypted_master_key = encrypt_master_key(
            decrypted_master_key, new_password, salt
        )

        # Verify data can be accessed with new password
        recovered_master_key = decrypt_master_key(
            new_encrypted_master_key, new_password, salt
        )
